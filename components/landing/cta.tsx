    ...
    <section style={{ padding: "96px 32px", backgroundColor: "#F5F2EC", borderTop: "1px solid #E8E2D5" }}>
      <div style={{ maxWidth: 1120, margin: "0 auto" }}>
        <motion.div
          ...
          className="cta-inner"
          style={{
            backgroundColor: "#0A0A0B", borderRadius: 20,
        ...
        >
          ...
          <div style={{ position: "relative" }}>
            <p style={{ margin: "0 0 16px", fontFamily: "var(--font-mono)", fontSize: 10, color: "#D4B68A", letterSpacing: "0.12em", textTransform: "uppercase" }}>
              Founding Partners
            </p>
            <h2 style={{
              ...
              Be among the first brands to{" "}
              <em style={{ fontStyle: "italic", color: "#C9A66B" }}>protect their legacy.</em>
            </h2>
            <p style={{
            ...
            <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
              ...
              <a
                ...
                style={{
                  display: "inline-flex", alignItems: "center",
                  padding: "13px 24px",
                  backgroundColor: "transparent", color: "#9E9EA3",
                  border: "1px solid rgba(212,182,138,0.2)",
                  borderRadius: 8, textDecoration: "none",
                  fontWeight: 450, fontSize: 14, letterSpacing: "-0.005em",
                }}
              >
                Request a Demo
              </a>

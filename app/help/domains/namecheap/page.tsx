...
export const metadata: Metadata = {
  title: "Connecting your domain on Namecheap — Tagit",
};

export default function NamecheapHelpPage() {
  return (
    <main style={{ maxWidth: 640, margin: "0 auto", padding: "48px 24px 80px", fontFamily: "system-ui, sans-serif" }}>
      ...
      <h1 style={{ fontSize: 28, fontWeight: 300, color: "#1C1C1C", letterSpacing: "-0.01em", lineHeight: 1.2, margin: "0 0 8px" }}>
        Connecting your domain on Namecheap
      </h1>
      ...
      <ol style={{ paddingLeft: 0, listStyle: "none", margin: 0 }}>
        <Step n={1} title="Sign in to Namecheap">
          Go to <strong>namecheap.com</strong> and sign in to your account.
        </Step>

        <Step n={2} title="Open your domain list">
          Click <strong>Domain List</strong> in the left sidebar. Find your domain (for example, bushuaart.com) and click <strong>Manage</strong>.
        </Step>

        <Step n={3} title="Open Advanced DNS">
          Click the <strong>Advanced DNS</strong> tab at the top of the domain page.
        </Step>

        <Step n={4} title="Add a new CNAME record">
          <p style={{ margin: "0 0 12px" }}>
            Scroll to <strong>Host Records</strong> and click <strong>Add New Record</strong>. Fill in the fields:
          </p>
          <RecordTable rows={[
            ["Type", "CNAME Record"],
            ["Host", "@"],
          ...
          <p style={{ margin: "12px 0 0", fontSize: 13, color: "#8B8B8B" }}>
            If there is an existing A record or CNAME for <strong>@</strong>, delete it first. Two records for the same host will conflict.
          </p>
        </Step>

        <Step n={5} title="Save and return to Tagit">
          Click the green <strong>tick</strong> icon to save the record. Then return to your Tagit settings and click <strong>Check Connection</strong>. It will confirm once the record has propagated.
        </Step>
      </ol>
